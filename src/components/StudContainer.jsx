    ...
    return (
      <div>
        <form className="wallDimensionsForm">
            width: <input type="number" value={pxToCm(this.state.wallWidth)} onChange={this.handleWidthChange}/><br/>
            height: <input type="number" value={pxToCm(this.state.wallHeight)} onChange={this.handleHeightChange}/><br/>
            left side: <select value={this.state.leftSideType} onChange={this.handleLeftSideTypeChange}>
                <option value="neutral"></option>
                <option value="female">Female</option>
                <option value="male">Male</option>
            </select><br/>
            right side: <select value={this.state.rightSideType} onChange={this.handleRightSideTypeChange}>
                <option value="neutral"></option>
                <option value="female">Female</option>
                <option value="male">Male</option>
            </select><br/>
